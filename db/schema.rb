...
ActiveRecord::Schema.define(version: 20131001233502) do
  ...
  add_index "sentiment_data", ["headline_id", "sentiment_engine"], name: "index_sentiment_data_on_headline_id_and_sentiment_engine", unique: true, using: :btree
